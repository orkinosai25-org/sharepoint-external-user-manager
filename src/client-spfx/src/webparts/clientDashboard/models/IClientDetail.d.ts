 ...
 */
export declare type ExternalUserPermission = 'Read' | 'Contribute' | 'Edit' | 'FullControl';
export declare type ExternalUserStatus = 'Active' | 'Invited' | 'Expired' | 'Removed';
...
//# sourceMappingURL=IClientDetail.d.ts.map