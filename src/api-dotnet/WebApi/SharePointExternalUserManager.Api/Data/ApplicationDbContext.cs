...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TenantUserEntity>(entity =>
        {
            ...
            // Unique constraint: one user-role per tenant
            entity.HasIndex(e => new { e.TenantId, e.AzureAdObjectId })
                .IsUnique()
                .HasDatabaseName("UQ_TenantUsers_TenantId_AzureAdObjectId");

            // Index on AzureAdObjectId for user lookups
            entity.HasIndex(e => e.AzureAdObjectId)
                .HasDatabaseName("IX_TenantUsers_AzureAdObjectId");
